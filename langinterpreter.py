...
class Function(BaseFunction):
    ...
    def execute(self, args):
        ...
        value = execute_result.register(interpreter.visit(self.body_node, exec_ctx))
        if execute_result.should_return() and execute_result.func_return_value == None:
            return execute_result

        return_val = (
            value if self.should_auto_return else None) or execute_result.func_return_value or Number.null
        return execute_result.success(return_val)
...
class Interpreter:
    ...
    def visit_BinOperatorNode(self, node, context):
        res = RuntimeResult()
