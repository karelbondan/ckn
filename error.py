...
class Error:
    ...
    def as_string(self):
        ...
        result += '\n\n' + showarrows(self.pos_start.ftxt, self.pos_start, self.pos_end)
        return result

# Will be raised by the LEXER when it detected an unknown syntax
...
# Will be raised by the PARSER when a token is illegible
...
class FileNotFoundError(Error):
  def __init__(self, pos_start, pos_end, details=''):
    super().__init__(pos_start, pos_end, 'FileNotFound', details)
